...
class DPStorage:
    class Transition:
        def __init__(self):
            ...
            self.reference_actions: torch.Tensor = None # type: ignore
            self.initial_noise: torch.Tensor = None # type: ignore
    ...
    def __init__(
        ...
        self.initial_noise = torch.zeros(num_transitions_per_env, num_envs, *actions_shape, device=self.device)
    ...
    def add_transitions(self, transition: Transition):
        ...
        self.initial_noise[self.step].copy_(transition.initial_noise)
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        reference_actions = self.reference_actions.flatten(0, 1)
        initial_noise = self.initial_noise.flatten(0, 1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                reference_actions_batch = reference_actions[batch_idx]
                initial_noise_batch = initial_noise[batch_idx]
                ...
                reference_actions_batch, initial_noise_batch, \
    ...
    def recurrent_mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for ep in range(num_epochs):
            ...
            for i in range(num_mini_batches):
                ...
                reference_actions_batch = self.reference_actions[:, start:stop]
                initial_noise_batch = self.initial_noise[:, start:stop]
                if not self.deterministic:
