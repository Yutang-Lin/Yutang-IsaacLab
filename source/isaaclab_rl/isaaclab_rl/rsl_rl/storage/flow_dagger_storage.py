...
class FlowDAggerStorage:
    class Transition:
        def __init__(self):
            ...
            self.flow_state: torch.Tensor = None # type: ignore
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        raise NotImplementedError("Mini batch generator is not implemented for Flow DAgger storage.")

    # for reinfrocement learning with recurrent networks
    def recurrent_mini_batch_generator(self, num_mini_batches, num_epochs=8):
        raise NotImplementedError("Recurrent mini batch generator is not implemented for Flow DAgger storage.")