...
from isaaclab_rl.rsl_rl.networks import TransformerMemoryLatent
from isaaclab_rl.rsl_rl.utils import resolve_nn_activation, TensorDict


class ActorCriticTFRecurrentLatent(ActorCritic):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if kwargs:
            print(
                "ActorCriticTFRecurrentLatent.__init__ got unexpected arguments, which will be ignored: " + str(kwargs.keys()),
            )
        ...
        self.memory_a = TransformerMemoryLatent(self.actor_proprio_ids.shape[0], 
                                         ...
                                         lnn_dt=tf_lnn_dt,
                                         lnn_tau=tf_lnn_tau)
        self.memory_c = TransformerMemoryLatent(self.critic_proprio_ids.shape[0], 
