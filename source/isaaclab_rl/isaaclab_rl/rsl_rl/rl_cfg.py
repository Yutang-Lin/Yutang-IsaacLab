...
class RslRlFBCprAlgorithmCfg:
    ...
    """Mean absolute canonical-joint position error threshold in radians."""
    ...
    """Segment duration for per-bin success EMA and adaptive failure resets.
    Values <= 0 disable segment bins."""
